"""Allow dedicated instant_deck_generation workflow jobs."""
...
revision = "20260730_0001_instant_deck_workflow_job_type"
down_revision = "20260727_0001_diligence_chat_reservations"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    _replace(_deployed_job_types() | {"instant_deck_generation"})


def downgrade() -> None:
    # Preserve historical workflow identities; removing accepted values would
    # invalidate existing rows after production execution.
