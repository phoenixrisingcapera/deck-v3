defmodule IdDidiSh.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind id_didi_sh", "esbuild id_didi_sh"],
      "assets.deploy": [
        "tailwind id_didi_sh --minify",
        "esbuild id_didi_sh --minify",
        "phx.digest"
      ],
