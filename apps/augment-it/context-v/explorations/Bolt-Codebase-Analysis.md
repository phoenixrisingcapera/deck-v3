...
lede: "A faithful architectural map of the bolt monolith — React + TS + Vite + Supabase + zustand — lifted from its own `specs/` folder."
...
authors:
  - Michael Staton
augmented_with:
  - Original analysis author unknown (pre-dates current attribution discipline — likely Tanuj or a prior AI session)
