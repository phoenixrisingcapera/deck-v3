// Standalone entry (:3004). theme.css provides the token system + base body
...
// http://localhost:3004/#/gallery/button/variants?iso=1 (or the LAN IP, where
// the point is that a reviewer needs neither the shell nor this repo).
...
//
// The catalog is imported DYNAMICALLY. It pulls in the shared Button, every
// specimen snippet and the whole recipe set; a static import would put all of
// that in the product bundle for the benefit of a URL almost nobody visits.
if (galleryRequested()) {
