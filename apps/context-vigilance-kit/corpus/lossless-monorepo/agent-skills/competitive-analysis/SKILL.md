...
description: Classify a target company's competitors on two orthogonal axes — the
  stage ring (concentric circles outward from the target's own stage) and the competitor
  type (direct / adjacent / indirect / noisewashing). Use whenever writing or reviewing
  the competitive landscape section of an investment memo; whenever asked "who are
  the competitors", "who else does this", or "is this company actually competing with
  X"; whenever a competitor list needs to be de-noised, ranked, or split between exhaustive
  research and the synthesized memo section; whenever an agent must decide if a named
  company belongs in a landscape at all. Encodes the stage-ring and competitor-type
  taxonomy, the classification discipline that keeps adjacent players from being mislabelled
  as direct, and the deliberate separation of the exhaustive research artifact from
  the memo-ready synthesis. Pairs with market-capture-analysis and timeline-scenario-analysis,
  the two foundational sizing skills.
title: Competitive Analysis Taxonomy
lede: 'Two orthogonal axes for classifying a target company''s competitors: the stage
  ring (concentric circles outward from the target''s own stage) and the competitor
  type (direct / adjacent / indirect / noisewashing). Reference for humans and for
  any agent writing the competitive landscape section.'
...
source_relative_path: agent-skills/competitive-analysis/SKILL.md
source_repo_slug: lossless-monorepo
collated_at: '2026-08-24'
source_path: "context-v/agent-skills/competitive-analysis/SKILL.md"
---
