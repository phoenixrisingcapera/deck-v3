...
source_relative_path: agent-skills/git-conventions/references/body-structure.md
source_repo_slug: lossless-monorepo
collated_at: '2026-08-24'
source_path: "context-v/agent-skills/git-conventions/references/body-structure.md"
---
