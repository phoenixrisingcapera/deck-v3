---
name: Chroma CLI
description: Getting started with the Chroma CLI for Chroma Cloud authentication and
  database management
source_root: /Users/mpstaton/code/lossless-monorepo/context-v
source_relative_path: agent-skills/chroma-agent-skills/src/chroma-cloud/general/cli.md
source_repo_slug: lossless-monorepo
collated_at: '2026-08-24'
source_path: "context-v/agent-skills/chroma-agent-skills/src/chroma-cloud/general/cli.md"
---

## Chroma CLI

The Chroma CLI lets you authenticate to Chroma Cloud, manage profiles, and create or connect to Cloud databases for your active profile.
...
Use this topic when the user needs to:

- log into Chroma Cloud
- create or list Cloud databases
- write Cloud environment variables into a `.env` file
- switch between Cloud profiles or teams

If the user only needs to run open source Chroma locally, use the CLI topic from `chroma-local` instead.
