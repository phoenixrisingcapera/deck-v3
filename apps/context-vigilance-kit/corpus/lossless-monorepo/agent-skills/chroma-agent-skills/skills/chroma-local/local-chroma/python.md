...
source_relative_path: agent-skills/chroma-agent-skills/skills/chroma-local/local-chroma/python.md
source_repo_slug: lossless-monorepo
collated_at: '2026-08-24'
source_path: "context-v/agent-skills/chroma-agent-skills/skills/chroma-local/local-chroma/python.md"
---
