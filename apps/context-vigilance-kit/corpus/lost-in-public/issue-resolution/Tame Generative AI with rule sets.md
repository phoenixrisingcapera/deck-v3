...
lede: Canonical rules and technical conventions for controlling, documenting, and
  collaborating with code-generating LLMs in complex TypeScript/Astro projects.
...
image_prompt: Developer workspace with AI code assistant, rulebooks, and TypeScript/Astro
  icons, all interconnected in a modern, organized layout.
...
source_relative_path: issue-resolution/Tame Generative AI with rule sets.md
source_repo_slug: lost-in-public
collated_at: '2026-08-24'
source_path: "content/lost-in-public/issue-resolution/Tame Generative AI with rule sets.md"
---
