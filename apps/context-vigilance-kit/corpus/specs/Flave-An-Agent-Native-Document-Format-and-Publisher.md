...
lede: A package format (.flave) and a Svelte+Tauri publisher that replace Pages, Keynote,
  and Word with a document whose internals are exactly the languages agents are already
  fluent in — LFM, HTML, CSS, JS, JSON, CSV, YAML, SVG, Vega-Lite, and D3.
