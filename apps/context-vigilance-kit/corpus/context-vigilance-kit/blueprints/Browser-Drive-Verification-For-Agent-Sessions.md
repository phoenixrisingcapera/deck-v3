---
title: Browser-drive verification as a kit practice — operationalizing the Playwright-MCP
  rung across every Lossless repo
lede: 'Not how an agent drives a browser — how the practice rolls out: a core-MCP
  registry, idempotent per-repo wiring, a CLAUDE.md block.'
