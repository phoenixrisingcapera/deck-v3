...
summary: Short authoritative reminder in cite-wide's context-v; an identical copy
...
source_path: "content-farm/plugin-modules/cite-wide/context-v/reminders/This-is-an-Obsidian-plugin-Read-Obsidian-API-Docs.md"
---
